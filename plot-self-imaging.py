...
plt.plot(z_sim * 1e2, wz2 * 1e6, label='Theory, 10 kW')
#plt.plot(z * 1e2, wz3 * 1e6, label='Theory, 100 kW')
...
# plt.plot(z_sim * 1e2, wz4_sim * 1e6, label='Sim, 10 kW (2)')
# plt.plot(z_sim * 1e2, wz5_sim * 1e6, label='Sim, 10 kW (3)')
