...
parser.add_argument('--input_type', type=str, default='mode', choices=['gaussian', 'mode', 'speckle'], help='Input type')
...
if input_type == 'mode':
    ...
    np.save(f'input_{input_type}_{beam_radius}_{position}_{int(total_power)}.npy', input_field)
    np.save(f'fields_{input_type}_{beam_radius}_{position}_{int(total_power)}.npy', fields)
