...
if input_type == 'mode':
    np.save(f'input_fiber_{input_type}_{num_modes}_{position}_{int(total_power)}.npy', input_field)
    np.save(f'fields_fiber_{input_type}_{num_modes}_{position}_{int(total_power)}.npy', fields)
    np.save(f'modes_fiber_{input_type}_{num_modes}_{position}_{int(total_power)}_{dz}.npy', modes)
